...
let fullText = '';  // <--- DODAJ OVO
let speechTimeout = null;  // <--- DODAJ OVO
...
function startVoiceRecognition() {
    ...
    const statusEl = document.getElementById('voiceStatus');
    if (statusEl) {
        statusEl.textContent = '🎤 Slušam... Govorite';
